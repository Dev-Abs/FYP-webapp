...
const AboutPage = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 via-gray-100 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-800 dark:text-gray-100">
      <NavbarDrawer />
      <Chatbot />
      
      {/* Hero section with enhanced visuals */}
      <motion.div 
        className="w-full py-12 md:py-20 px-4 bg-gradient-to-r from-indigo-700 to-purple-700 dark:from-indigo-800 dark:to-purple-900 relative overflow-hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div className="container mx-auto px-4 md:px-6 py-8 md:py-12">
        ...
        >
          {/* About Project Card */}
          <motion.div
            className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl dark:shadow-indigo-900/20 p-6 md:p-10 mb-8 md:mb-10 border-l-4 border-indigo-500 transition-all duration-300 transform hover:-translate-y-1"
            variants={fadeIn}
          >
            <h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6 text-indigo-600 dark:text-indigo-400 flex items-center">
          ...
          <motion.div
            className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl dark:shadow-blue-900/20 p-6 md:p-10 mb-8 md:mb-10 border-l-4 border-blue-500 transition-all duration-300 transform hover:-translate-y-1"
            variants={slideIn}
          >
            <h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6 text-blue-600 dark:text-blue-400 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 mr-2 md:mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Our Approach Card */}
          <motion.div
            className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl dark:shadow-purple-900/20 p-6 md:p-10 mb-8 md:mb-12 border-l-4 border-purple-500 transition-all duration-300 transform hover:-translate-y-1"
            variants={fadeIn}
          >
            <h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6 text-purple-600 dark:text-purple-400 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 mr-2 md:mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Team Section */}
          <motion.div
            className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800/80 dark:to-gray-900/80 backdrop-blur-sm rounded-2xl shadow-xl dark:shadow-gray-900/30 p-6 md:p-10 border-t-4 border-indigo-500"
            variants={fadeIn}
          >
            <div className="text-center mb-6 md:mb-10">
              <h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6 text-indigo-600 dark:text-indigo-400 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 mr-2 md:mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
                Meet the Team
              </h2>
              <p className="text-base md:text-lg leading-relaxed text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                A dedicated team of engineers and researchers focused on
                transforming mental health diagnostics through EEG technology.
              </p>
              <p className="text-sm text-indigo-500 mt-4 italic font-medium">
                {isMobile ? (
      ...
      {/* Footer */}
      <div className="bg-gray-100 dark:bg-gray-800 py-4 md:py-6 border-t border-gray-200 dark:border-gray-700">
