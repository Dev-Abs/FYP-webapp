...
const Results = ({ history }) => {
  ...
  const latestElectrodes = history[0]?.electrodes ? 
    (typeof history[0].electrodes === 'string' ? history[0].electrodes.split(', ') : history[0].electrodes) 
    : [];
  ...
  return (
    <div className="min-h-screen bg-gray-900 relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute inset-0 opacity-20 bg-[url('/neural-grid.png')] bg-repeat"></div>
        ...
        <div className="absolute inset-0">
          {[...Array(50)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute rounded-full bg-blue-500/20 w-2 h-2"
              style={{
        ...
        <video
          ...
          muted
          loop
          className="fixed inset-0 w-full h-full object-cover opacity-30 mix-blend-luminosity"
        >
        ...
        <div className="absolute bottom-0 left-0 w-2/3 h-1/3 bg-indigo-600/10 rounded-full filter blur-3xl"></div>
        <div className="absolute top-0 right-0 w-1/2 h-1/3 bg-blue-600/10 rounded-full filter blur-3xl"></div>
      </div>
        ...
        <div className="max-w-7xl mx-auto mb-8">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 text-lg">
              {history.length > 0
                ? `${history.length} EEG analysis record${history.length !== 1 ? 's' : ''} found`
            ...
            {history.length > 0 && (
              <div className="flex justify-center mb-8">
                <div className="bg-gray-800/40 backdrop-blur-sm p-1 rounded-xl inline-flex border border-gray-700/40">
                  <button
        ...
        <AnimatePresence mode="wait">
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                >
                  <div className="bg-gray-800/40 backdrop-blur-sm rounded-2xl p-6 h-full border border-gray-700/40 overflow-hidden relative shadow-xl">
                ...
                <div className="lg:col-span-2">
                  ...
                  >
                    ...
                    <motion.div whileHover={{ y: -5 }}>
                      <div className="bg-gray-800/40 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/40 h-full shadow-xl relative overflow-hidden">
                        {/* Card header with gradient */}
                          ...
                          {metrics.map((metric) => (
                            ...
                            >
                              ...
                              <div className="w-full h-2 bg-gray-700 rounded-full overflow-hidden">
                                <motion.div 
                                  className={`h-full ${
                                    metric.status === "Depressed" ? "bg-red-500" : "bg-green-500"
                                  }`}
                                  initial={{ width: 0 }}
                    ...
                    <motion.div whileHover={{ y: -5 }}>
                      <div className="bg-gray-800/40 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/40 h-full shadow-xl relative overflow-hidden">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-700/30 border border-gray-700/40">
                            ...
                            <div>
                              ...
                              <div className="text-white">{formatDate(history[0]?.date || new Date())}</div>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-700/30 border border-gray-700/40">
                            ...
                            <div>
                              ...
                              <div className="text-white">{history[0]?.modelVersion || "1.0.0"}</div>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-700/30 border border-gray-700/40">
                            ...
                            <div>
                              <div className="text-gray-400 text-xs">Electrodes Selected</div>
                              <div className="text-white">
                                {latestElectrodes.length === 0 ? "All (Default)" : `${latestElectrodes.length} selected`}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-700/30 border border-gray-700/40">
                            ...
                            <div>
                              <div className="text-gray-400 text-xs">File Format</div>
                              <div className="text-white">Electroencephalogram (EDF)</div>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          {activeTab === "history" && (
            <motion.div
              ...
              className="max-w-7xl mx-auto"
            >
              <div className="bg-gray-800/40 backdrop-blur-sm rounded-2xl border border-gray-700/40 overflow-hidden shadow-xl">
                {/* Card header with gradient */}
                  ...
                  {history.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {history.map((session, sessionIndex) => {
                        ...
                        const sessionElectrodes = getElectrodesArray(session.electrodes);
                        ...
                        return (
                          <motion.div
                            ...
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.1 + sessionIndex * 0.05, duration: 0.3 }}
                            whileHover={{ y: -2 }}
                          >
                            {/* Session Header */}
                            <div 
                                  ...
                                  <div className="relative flex-shrink-0">
                                    ...
                                    <div 
                                      className={`absolute -top-1 -right-1 w-4 h-4 rounded-full border-2 border-gray-800 ${
                                        session.status === "Depressed" ? "bg-red-500" : "bg-green-500"
                                      }`}
                                    ></div>
                                  </div>
                                ...
                                >
                                  <div className="px-4 pb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                                      ...
                                      {sessionElectrodes.length > 0 && (
                                        <div className="md:col-span-1 bg-gray-800/70 rounded-xl p-4 border border-gray-700/40 shadow-inner">
                                          ...
                                          <SelectedElectrodesDisplay 
                                            selectedElectrodes={sessionElectrodes} 
                                            small={true} 
                                            enhancedDisplay={true}
                                          />
                                        </div>
                                      ...
                                      {/* Results */}
                                      <div className={`${sessionElectrodes.length > 0 ? "md:col-span-2" : "md:col-span-3"} grid grid-cols-1 md:grid-cols-2 gap-3`}>
                                        {Array.isArray(session.results)
                                          ? session.results.map((result, index) => (
                                              <div
                                                key={index}
                                                className={`bg-gray-800/70 p-4 rounded-xl ${
                                                  result > 0.5 
                                              ...
                                              >
                                                ...
                                                <div className="w-full h-2 bg-gray-700 rounded-full overflow-hidden">
                                                  <div 
                                                    className={`h-full ${result > 0.5 ? "bg-red-500" : "bg-green-500"}`}
                                              ...
                                              ([key, value], index) => (
                                                ...
                                                >
                                                  ...
                                                  {typeof value === "number" && (
                                                    <div className="w-full h-2 bg-gray-700 rounded-full overflow-hidden">
                                                      <div 
                                                        className={`h-full ${value > 0.5 ? "bg-red-500" : "bg-green-500"}`}
                                        ...
                                        {/* Additional metadata */}
                                        <div className="bg-gray-800/70 p-4 rounded-xl border border-gray-700/40">
                                          ...
                                          <div className="space-y-2 text-sm">
                                            <div className="flex justify-between items-center p-2 rounded bg-gray-700/30">
                                              ...
                                              <span className="text-gray-200 font-medium">{session.modelVersion || "1.0.0"}</span>
                                            </div>
                                            <div className="flex justify-between items-center p-2 rounded bg-gray-700/30">
                                              <span className="text-gray-400">Analysis Date</span>
                                              <span className="text-gray-200 font-medium">{formatDate(session.date)}</span>
                                            </div>
                                            <div className="flex justify-between items-center p-2 rounded bg-gray-700/30">
                                              <span className="text-gray-400">Electrode Count</span>
                                              <span className="text-gray-200 font-medium">
                                                {sessionElectrodes.length > 0 ? sessionElectrodes.length : "All (Default)"}
                                              </span>
                                            </div>
                                          </div>
                                        </div>
          ...
          {history.length === 0 && (
            <motion.div
              ...
              className="bg-gray-800/40 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/40 text-center max-w-3xl mx-auto shadow-xl"
            >
              <motion.div 
                className="w-24 h-24 rounded-full bg-indigo-600/20 mx-auto mb-6 flex items-center justify-center"
                animate={{ 
                  boxShadow: ["0 0 0 rgba(79, 70, 229, 0.4)", "0 0 30px rgba(79, 70, 229, 0.6)", "0 0 0 rgba(79, 70, 229, 0.4)"] 
                }}
              ...
              <h3 className="text-3xl font-bold text-white mb-3">No Analysis Data Yet</h3>
              <p className="text-gray-400 max-w-md mx-auto mb-8">
                You haven't analyzed any EEG files yet. Upload an EDF file to get started 
                with your neural analysis.
              </p>
